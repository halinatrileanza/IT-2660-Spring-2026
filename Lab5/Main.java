...
class Main {
  public static void main(String[] args) {
    ...
    ArrayList<BST.TreeNode<Integer>> data1 = lab5Tree.path(2);
    for (BST.TreeNode node : data1) {
    ...
    ArrayList<BST.TreeNode<Integer>> data2 = lab5Tree.path(34);
    for (BST.TreeNode node : data2) {
      System.out.print(node.element);
      System.out.print(" ");
    }
    System.out.println();
